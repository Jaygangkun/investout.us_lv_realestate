    ...
    a.validationEngineLanguage = {
        newLang: function() {
            a.validationEngineLanguage.allRules = {
                ...
                date: {
                    func: function(h) {
                        var f = new RegExp(/^(\d{4})[\/\-\.](0?[1-9]|1[012])[\/\-\.](0?[1-9]|[12][0-9]|3[01])$/);
                        var d = f.exec(h.val());
                        if (d == null) {
                            return false
                        }
                        ...
                        return (c.getFullYear() == e && c.getMonth() == (g - 1) && c.getDate() == b)
                    },
                ...
                customPassword: {
                	...
                	alertText: "* Minimum 6 characters, at least one letter, one number and one special character"
                }
            }
        }
    };
