...
function calculationsRealtor() {
    ...
    // Get Realtors Commission Percent
    let realtors_commission_percent_b30 = $("#realtors_commission_percent").val() == "" ? "0" : $("#realtors_commission_percent").val().replace(/,/g, "");
    realtors_commission_percent_b30 = str2Float(realtors_commission_percent_b30) / 100;

    
    // Calculate Realtor's Commission
    let realtors_commission_c30 = realtors_commission_percent_b30 * arv_e10;
    $("#realtors_commission").val(numberWithCommas(realtors_commission_c30));
    
    // Calculate Realtor's Non-Partner Commission
    let realtors_non_partner_commission_d30 = realtors_commission_percent_b30 * brv_b14;
    $("#realtors_non_partner_commission").val(numberWithCommas(realtors_non_partner_commission_d30));

    // Calculate Realtor's Increased Commission
    let realtors_increased_commission_e30 = realtors_commission_c30 - realtors_non_partner_commission_d30;
    $("#realtors_increased_commission").val(numberWithCommas(realtors_increased_commission_e30));
