...
@section('body')
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="{{asset('assets/front_end/img/slider/slider_2.jpg')}}">
                <div class="container">
                    <div class="row">
            ...
            <div class="single-hero-item set-bg" data-setbg="{{asset('assets/front_end/img/slider/slider_1.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="{{asset('assets/front_end/img/slider/slider_3.jpg')}}">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            <div class="hero-text">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="properties-title">
                        ...
                        <!-- <a href="{{ route('property_lists') }}" class="top-property-all">View All Properties</a> -->
                    </div>
                </div>
            </div>
        </div>
