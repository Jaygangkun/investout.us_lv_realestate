                                                      ...
                                                      <tbody>
                                                              @foreach ($proposals as $key=>$proposal )
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td><a href="{{route('brokeragehouse.property.show',$proposal->property_id)}}">{{$proposal->property_id}} </a></td>
                                                                      <td>{{ date('d-M-Y', strtotime($proposal->created_at)) }}</td>
                                                                      <td>
                                                                        <form action="{{route('brokeragehouse.proposal.update')}}" method='post'>
                                                                            @csrf
                                                                    ...
                                                                    <td>
                                                                        {!! Form::open(['method' => 'post', 'route' => ['brokeragehouse.proposal.update'], 'class' => 'form-horizontal denyForm']) !!}
                                                                            <input type="hidden" name='pro_id' value={{$proposal->id}}>
