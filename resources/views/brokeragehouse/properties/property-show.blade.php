                ...
                <br>
                  ...
                  <div class="row">
                    <div class="col-sm-12 text-right" style='padding-right: 7.8em;font-size:.8em'>
                      ...
                      <iframe src="https://www.facebook.com/plugins/share_button.php?href=<?php echo $url; ?>&layout=button_count&size=small&appId=264923528245115&width=89&height=20" width="89" height="20" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
                      
                      <a  class='btn btn-primary' href="https://www.facebook.com/sharer/sharer.php?u={{$url}}" target="_blank">Share on Facebook</a>
                      <button id='shareBtn' type='button' class='btn btn-primary'>Share On Facebook</button>
                    </div>
                  </div>
