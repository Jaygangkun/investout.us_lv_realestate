                                ...
                                <div class="row">                                
                                    ...
                                    <div class="col-xs-12">
                                        <div class="frm-grp{{ $errors->has('partner_up') ? ' has-error' : '' }}">
                                            ...
                                            @if(isset($details))
                                                ...
                                                @endif
                                            @else
                                                <input type="radio" name="partner_up" class="partner_up" checked value="1">Yes
                                            @endif
                                            </label>
                                            <label class="radio-inline">
                                            @if(isset($details))
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {!! Form::submit("Add Property", ['class' => 'btn btn-success','style'=>'color:white;width:120px;padding:.8em']) !!}
                                        </div>
                                    </div>
                                </div>
                            </form>
