                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="allproperty_row">
                                                    ...
                                                    <td class="client-avatar"><a href="{{ route('investors.property.show',$property->id) }}"><img alt="image" src="{{ asset('properties/'.$property->id.'/images/'.$property->images->first()->image)}}"> </a>                                                        @else
                                                        <td class="client-avatar"><a href="{{ route('investors.property.show',$property->id) }}"><img alt="image" src="{{ asset('dashboard/seller/default-property.png')}}"> </a>                                                            @endif
                                                        </td>
                                                        <td>{{$property->id}}</td>
