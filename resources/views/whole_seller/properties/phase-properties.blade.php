        ...
        <div class="ibox float-e-margins">
          <div class="ibox-title">
            <div class="row">
              ...
              <div class="col-md-2 {{$add_property_allowance}}">
                @if($add_property_allowance == true)
          ...
          @endif
          @if ($add_property_allowance == false)
            <div class="alert alert-danger">
                    Your quota is over, Please upgrade your subscription to add more property.
            </div>
            <a class="btn btn-primary dim" href="{{ route('upgradeSub') }}">Upgrade your subscription</a>
          @endif
                ...
                <div class="panel-body">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab-1">
                      <!-- <a href="{{route('seller.property.phase-index',0)}}"><button type="button" class='btn apply-button' @if($phase == 0) style='background: #1ab394;border: 1px solid #1ab394;' @endif name="button">New Properties</button></a>
                      <a href="{{route('seller.property.phase-index',1)}}"><button type="button" class='btn apply-button' @if($phase == 1) style='background: #1ab394;border: 1px solid #1ab394;' @endif name="button">Seller Validation</button></a>
                      <a href="{{route('seller.property.phase-index',2)}}"><button type="button" class='btn apply-button' @if($phase == 2) style='background: #1ab394;border: 1px solid #1ab394;' @endif name="button">Evaluation</button></a>
                      <a href="{{route('seller.property.phase-index',3)}}"><button type="button" class='btn apply-button' @if($phase == 3) style='background: #1ab394;border: 1px solid #1ab394;' @endif name="button">Title & lines Search</button></a>
                      <a href="{{route('seller.property.phase-index',4)}}"><button type="button" class='btn apply-button' @if($phase == 4) style='background: #1ab394;border: 1px solid #1ab394;' @endif name="button">Property Market Evaluation</button></a>
                      <a href="{{route('seller.property.phase-index',5)}}"><button type="button" class='btn apply-button' @if($phase == 5) style='background: #1ab394;border: 1px solid #1ab394;' @endif name="button">Approved</button></a> -->
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr class="allproperty_row {{ $property->acceptance_level == 5 ? 'approved-property' : '' }}">
                            <?php
                            ...
                            <td class="client-avatar">
                              <a href="{{ route('seller.property.show',$property->propertiesID) }}">
                                @php
                            ...
                            <td><a href="{{ route('whole-seller.proposal.list',['property_id'=>$property->propertiesID]) }}" class="proposal-count-info"><i class="fa fa-list-alt" style="font-size:21px;color: #36b394;" aria-hidden="true"></i><span class="label lab1 label-warning">{{$property->unread_proposals}}</span></a></td>
