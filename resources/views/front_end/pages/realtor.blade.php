...
<!-- Breadcrumb Section Begin -->
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="{{asset('assets/front_end/img/realtor/top.jpg')}}">
            </div>
            </div>
        </div>
 ...
 Invest Out Model creates options for homeowners and investors. Whether the homeowner wants to increase their profits or simply sell fast, the Partnering process provides options.
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="{{asset('assets/front_end/img/realtor/last.jpg')}}">
            </div>
            </div>
        </div>
        <div class="thumbnail-pic">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <img src="{{asset('assets/front_end/img/realtor/graphic.png')}}" alt="">
                </div>
            </div>
        </div>
    </section>
    <div class="container text-center">
        <img src="{{asset('assets/front_end/img/BeforeAfterrealtor.png')}}">
    </div>
    <div class="container text-center">
    ...
    <div class="text-center">
        <img src="{{asset('assets/front_end/img/realtor/realtor.png')}}">
    </div>
