                                                      ...
                                                      <tbody>
                                                              @foreach ($users as $key=>$user )
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td>{{$user->email }}</td>
                                                                      <td>{{$user->assign_zip_code }}</td>
                                                                      <td>{{ date('d-M-Y', strtotime($user->created_at)) }}</td>
                                                                      <td>{{ $user->updated_at->diffForHumans() }}</td>
                                                                      <td>
                                                                        <a href="{{ route('admin.users.edit_envoy', [$user->id]) }}" class="btn btn-success" data-user_id="{{ $user->id }}"><i class="fa fa-pencil"></i></a>&nbsp;
              ...
              <div class="modal-dialog adminRegistration">
                  <div class="modal-content animated fadeIn">
                      ...
                      <div class="modal-body">
                          <form class="m-t" role="form" action="{{ route('admin.users.envoy-create') }}" id="adminRegistration" method="POST">
                              {{csrf_field()}}
