...
@section('style')
  ...
  <style media="screen">
    ...
    .bootstrap-select .dropdown-menu, .bootstrap-select .dropdown-menu>li>a {
                            ...
                            <input type='hidden' name='is_edit' value="{{ app('request')->input('pid') ?? '-99' }}">
                                <div class="step-1">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <?php
                                        if(auth()->user()->assign_zip_code == '' || auth()->user()->assign_zip_code == null)
                                        {
                                        ?>
                                            <div class="form-group col-md-6">
                                        ...
                                        {
                                            $assignedZipcodes = explode(",",auth()->user()->assign_zip_code);
                                        ?>
                                            <div class="form-group col-md-6">
                                                <label for="zip">Zip Code*</label> <br>
                                                <select name="zip" class='form-control validate[required]' id="">
                                                    @foreach($assignedZipcodes as $assignedZipcode)
                                                        @if(isset($edit_properties) && $edit_properties->zip == $assignedZipcode)
                                                            <option value='{{$assignedZipcode}}' selected>{{$assignedZipcode}}</option>
                                                        @else
                                                            <option value='{{$assignedZipcode}}'>{{$assignedZipcode}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                <small class="text-danger">{{ $errors->first('zip') }}</small>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Select Property Owner</label><br>
                                            <select name="property_owner_select" id="property_owner_select" class="selectpicker form-control" data-live-search="true" showSubtext="true">
                                                @foreach($roles as $role)
                                                    <optgroup label="{{$role->name}}">
                                                    @foreach($all_users as $user)
                                                        @if($role->id == $user->role_id)
                                                            <option value="{{$user->id}}" data-subtext="{{$user->email}}" <?php echo app('request')->input('pid') && $edit_properties->user_id == $user->id ? "selected" : auth()->user()->id == $user->id ? "selected" : "";?>>{{ $user->first_name}} {{$user->last_name}}</option>
                                                        @endif
                                                    @endforeach
                                                    </optgroup>
                                                @endforeach
                                ...
                                <div class="step-2">
                                    <div class="form-row">
                                        <div class="form-group col-md-12" style="<?php if($edit_properties->seller()->first()->roles()->first()->slug == 'wholeseller'){ echo "display:none;"; } ?>">
                                            <div class="">
                                    ...
                                    <div class="form-row partner_up_row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" step=".01" name='square_footage' id='square_footage' value='{{$details->square_footage ?? ""}}' class='form-control amountComma validate[min[0],maxSize[10]]'>
                                                ...
                                                @if(isset($details))
                                                    ...
                                                    @if($details->home_condition == '4')
                                                        <div class="form-group col-md-offset-10 col-md-2 other_home_condition">
                                                            <input type="text" name='other_home_condition_value' id='other_home_condition_value' value='{{$details->other_home_condition_value ?? ""}}' class='form-control amountComma validate[min[0],maxSize[10]]'>
                                                        </div>
                                                    @else
                                    ...
                                    <div class="form-row partner_up_row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1">$</span>
                                                <input type="text" name='estimated_repair_cost' id='estimated_repair_cost' value='{{$details->estimated_repair_cost ?? ""}}' class='form-control amountComma validate[min[0],maxSize[10]]'>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1">$</span>
                                                <input type="text" name='arv_price' id='arv_price' value='{{$details->arv_price ?? ""}}' class='form-control amountComma validate[min[0],maxSize[10]]'>
                                            </div>
                                    ...
                                    <div class="form-row seller_profit_share partner_up_row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <?php
                                            if($edit_properties->seller()->first()->roles()->first()->slug == 'wholeseller')
                                            {
                                            ?>
                                    ...
                                    <div class="form-row partner_up_row" style="<?php if($edit_properties->seller()->first()->roles()->first()->slug == 'wholeseller'){ echo "display:none;"; } ?>">
                                        <div class="form-group col-md-4">
...
<script src="{{ URL::asset('assets/front_end/js/chartjs-plugin-datalabels.js') }}"></script>
    ...
    <script>
        ...
        $('#property_owner_select').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
        // do something...
