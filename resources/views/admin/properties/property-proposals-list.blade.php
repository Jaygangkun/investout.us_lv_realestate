                  ...
                  <div class="col-lg-12">
                      <div class="ibox float-e-margins">
                          <div class="ibox-title">
                               <h2 style='color:#0b2a4a;font-family:unisansboldbold;font-weight:100'><b style='font-weight:100'>All Proposal For Property ID: {{$property_id}}</b></h2>
                          </div>
                                                      ...
                                                      <tbody>
                                                              @foreach ($proposalsLists as $key=>$proposal )
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td>{{$proposal->max_seller_share}}</td>
                                                                      <td>{{100 - $proposal->max_seller_share}}</td>
                                                                      <!-- <td>
                                                                        {{$proposal->created_at}}
                                                                      </td> -->
                                                                      ...
                                                                      <!-- <td></td> -->
                                                                      <td>
                                                                      <a href="{{ route('admin.property.investorProposals.view',['property_id'=>$proposal->property_id, 'investor_id'=>$proposal->from_user]) }}" class="proposal-count-info"><i class="fa fa-list-alt" style="font-size:21px;color: #36b394;" aria-hidden="true"></i></a>
                                                                      </td>
