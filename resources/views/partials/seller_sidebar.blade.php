        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a class="{{ request()->is('investor-propertys') ? 'active' : '' }}" href="{{route('seller.index')}}"><i class="fa fa-dashboard" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="{{ route('seller.property.phase-index',5) }}" class=""><i class="fa fa-cubes"></i> <span class="nav-label">My Properties</span></a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="{{ route('seller.proposal.show') }}"> <span class="nav-label">Received Proposals</span></a></li>
                            <li><a href="{{ route('seller.proposal.approved.show')}}"> <span class="nav-label">Accepted Proposals</span></a></li>
                            <!-- <li><a href="{{ route('seller.proposal.denied.show')}}"> <span class="nav-label">Denied Proposals</span></a></li> -->
                        </ul>
                    </li>
                    <li>
                    ...
                    <!--<li>
                        <a class="{{ request()->is('*/document') ? 'active' : '' }}"  href="{{route('seller.viewDocument')}}"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">Document</span></a>
                    </li>
                    <li><a class="{{ request()->is('new_property') ? 'active' : '' }}" href="{{-- route('seller.property.create') --}}"><i class="fa fa-file-zip-o"></i>New Listing</a></li>

                    <li><a class="{{ request()->is('all_property') ? 'active' : '' }}" href="{{-- route('seller.property.index') --}}"><i class="fa fa-outdent"></i>All Listing</a></li>-->
                    <!--<li>
