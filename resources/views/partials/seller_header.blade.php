    ...
    <nav class="navbar navbar-inverse custom-navbar  navbar-fixed-top">
        <div class="container-fluid ">
            ...
            <span class="icon-bar"></span>
                ...
                <a class="navbar-brand custom-navbar-brand" href="{{ route('seller.index') }}">
                <img class="colaborator-logo-inline header-circle-img" src="{{asset('sitefront/log.png')}}" style='width:auto'>
          </a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav seller-header-nav">
                    <li class="dropdown">
                        <a class="dropdown-toggle" style="border:none" data-toggle="dropdown" href="#">Properties <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('seller.property.index') }}">All Listing</a></li>
                            <li><a href="{{ route('seller.property.create') }}">New Listing</a></li>
                        </ul>
                    </li>
                </ul>
