    ...
    <nav class="navbar navbar-inverse custom-navbar  navbar-fixed-top">
        <div class="container-fluid ">
            ...
            <span class="icon-bar"></span>
                ...
                <a class="navbar-brand custom-navbar-brand" href="{{ route('whole-seller.index') }}">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <span class="caret"></span>
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('profile.show','whole-seller') }}">View Your Profile</a></li>
                            <li><a href="{{ route('profile.edit','whole-seller') }}">Edit Your Profile</a></li>
                            <li><a href="{{ route('whole-seller.billingDetails') }}">Billing Details</a></li>
