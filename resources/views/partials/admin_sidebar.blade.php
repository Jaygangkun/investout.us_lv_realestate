            ...
            <ul class="nav" id="side-menu">
              ...
              ?>
                ...
                ?>
                    ...
                    <li>
                        <!-- <a href="{{ route('admin.users.envoy-index') }}" class="dropdown"><i class="fa fa-money"></i> <span class="nav-label">Envoys</span></a> -->
                        <a href="#" class="dropdown"><i class="fa fa-money"></i> <span class="nav-label">Envoys</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="{{ route('admin.users.envoy-index') }}">Envoys List</a></li>
                ...
                <li>
                    <a href="{{ route('admin.property.phase-index',5) }}" class="dropdown"><i class="fa fa-cubes"></i> <span class="nav-label">Properties</span></a>
                </li>
                <!-- <li>
