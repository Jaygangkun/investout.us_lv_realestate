    ...
    <nav class="navbar navbar-inverse custom-navbar  navbar-fixed-top">
        <div class="container-fluid ">
            ...
            <span class="icon-bar"></span>
                ...
                <a class="navbar-brand custom-navbar-brand" href="{{ route('brokeragehouse.index') }}">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ route('brokeragehouse.showprofile') }}">View Your Profile</a></li>
                            <li><a href="{{ route('brokeragehouse.editprofile') }}">Edit Your Profile</a></li>
                            <li><a href="{{ route('brokeragehouse.billingDetails') }}">Billing Details</a></li>
                            <li><a href="{{ route('brokeragehouse.changepassword') }}">Change Password</a></li>
                            <li class="divider"></li>
                            <li>
