                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr class="allproperty_row {{ $property->acceptance_level == 5 ? 'approved-property' : '' }}">
                            ...
                            <td><a href="{{ route('seller.proposal.list',['property_id'=>$property->propertiesID]) }}" class="proposal-count-info"><i class="fa fa-list-alt" style="font-size:21px;color: #36b394;" aria-hidden="true"></i><span class="label lab1 label-warning">{{$property->unread_proposals}}</span></a></td>
