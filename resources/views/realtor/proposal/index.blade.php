                                                      ...
                                                      <tbody>
                                                              @foreach ($proposals as $key=>$proposal )
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td><a href="{{route('realtors.property.show',$proposal->property_id)}}">{{$proposal->property_id}} </a></td>
                                                                      <td>{{ date('d-M-Y', strtotime($proposal->created_at)) }}</td>
                                                                      <td>
                                                                        <form action="{{route('realtors.proposal.update')}}" method='post'>
                                                                            @csrf
                                                                    ...
                                                                    <td>
                                                                        {!! Form::open(['method' => 'post', 'route' => ['realtors.proposal.update'], 'class' => 'form-horizontal denyForm']) !!}
                                                                            <input type="hidden" name='pro_id' value={{$proposal->id}}>
