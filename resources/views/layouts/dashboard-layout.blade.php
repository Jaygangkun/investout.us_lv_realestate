...
<head>
  ...
  <link href="{{ url('css/colaborator.css') }}" rel="stylesheet">
  <link href="{{ url('css/dashboard.css') }}" rel="stylesheet">
  <link href="{{ url('css/validationEngine.jquery.css') }}" rel="stylesheet">
...
<body>
  ...
  <script src="{{ url('js/jquery.validationEngine-en.min.js') }}" type="text/javascript" charset="utf-8"></script>
  <script src="{{ url('js/jquery.validationEngine.min.js') }}" type="text/javascript" charset="utf-8"></script>
  ...
  channel.bind({{$user->id}} , function(message) {
      newAlert(1);
      newNotification(1);
