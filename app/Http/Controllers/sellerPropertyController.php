...
class sellerPropertyController extends Controller
{
    ...
    public function getUserProperty($id)
    {
        ...
        return view('seller.properties.all-user-properties', compact('properties'));
    }
    ...
    public function showUserProperty($id)
    {
        ...
        return view('seller.properties.property-show', compact('property', 'condition'));
    }
    ...
    public function getPhaseProperties($phase)
    {
        ...
        $subscriptions = SubscriptionHistory::where('stripe_cus_id','=',$stripe_cus_id)->orderBy('transaction_date', 'DESC')->get();
        ...
        if($properties->count() > 0 && $active_subscription->plan_amt == 0)
        {
        ...
        return view('seller.properties.phase-properties', compact('properties', 'phase', 'phasenum', 'add_property_allowance'));
    }
    ...
    public function getApprovedProperties()
    {
        ...
        $approve_page = true;
        $page_title = 'Listed';
        return view('seller.properties.approved-properties', compact('properties', 'approve_page', 'page_title'));
    }
    ...
    public function propertyProposalsList($property_id)
    {
        ...
        return view('seller.property.property-proposals-list', compact('proposalsLists', 'property_id', 'acceptedProposal'));
    ...
    public function investorProposalsView($property_id, $investor_id)
    {
        ...
        return view('seller.property.property-investorProposals-list', compact('property', 'investor', 'accepted_proposal'));
    }
