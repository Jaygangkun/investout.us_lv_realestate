    ...
    <nav class="navbar navbar-inverse custom-navbar  navbar-fixed-top">
        <div class="container-fluid ">
            ...
            <span class="icon-bar"></span>
                ...
                <a class="navbar-brand custom-navbar-brand" href="<?php echo e(route('investors.index')); ?>">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <span class="caret"></span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?php echo e(route('investors.billingDetails')); ?>">Billing Details</a></li>
