                                                ...
                                                <tbody>
                                                        <?php $__currentLoopData = $proposalsLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr class="allproperty_row">
                                                                ...
                                                                <!-- <td></td> -->
                                                                <td>
                                                                <a href="<?php echo e(route('whole-seller.investorProposals.view',['property_id'=>$proposal->property_id, 'investor_id'=>$proposal->from_user])); ?>" class="proposal-count-info"><i class="fa fa-list-alt" style="font-size:21px;color: #36b394;" aria-hidden="true"></i><span class="label lab1 label-warning"><?php echo e($proposal->unread_proposals); ?></span></a>
                                                                </td>
