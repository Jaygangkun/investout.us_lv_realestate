                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab-1">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                <?php $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($key+1); ?></td>
                                                        <td><?php echo e($inquiry->first_name.' '.$inquiry->last_name); ?></td>
                                                        <td><?php echo e($inquiry->email); ?></td>
                                                        <td><?php echo e($inquiry->mobile_number); ?></td>
                                                        <td><?php echo e($inquiry->zipcode); ?></td>
                                                        <td><?php echo e($inquiry->date); ?></td>
                                                        <td><?php echo e($inquiry->bookings->start_time); ?></td>
                                                        <td><?php echo e($inquiry->bookings->end_time); ?></td>
                                                        <?php if($inquiry->is_approved==0): ?>
                                                            <td style="text-align: left">
                                                                <a href="<?php echo e(route('inquiry.accept',$inquiry->id)); ?>">
                                                                    <button class="btn btn-sm btn-primary">Approve</button>
                                                                </a>
                                                                <a href="<?php echo e(route('inquiry.reject',$inquiry->id)); ?>">
                                                                    <button class="btn btn-sm btn-primary">Reject</button>
                                                                </a>
                                                            </td>
                                                        <?php else: ?>
                                                            <?php if($inquiry->is_approved==1): ?>
                                                            <td style="text-align: left"> <button class="btn btn-sm btn-primary">Approved</button></td>
                                                                ...
                                                                <?php endif; ?>
                                                        <?php endif; ?>
                                                        <td><a href="<?php echo e(route('inquiry.edit',$inquiry->id)); ?>"><i class="fa fa-pencil-square-o" style="font-size:21px;color: #36b394;" aria-hidden="true"></i></a></td>
                                                        <td><a onclick="DeleteModal('<?php echo e(route('delete.inquiry',$inquiry->id)); ?>');return false;" href="#" id="delProperty"><i class="fa fa-trash" style="font-size:21px;color: #36b394;" aria-hidden="true"></i></a></td>
