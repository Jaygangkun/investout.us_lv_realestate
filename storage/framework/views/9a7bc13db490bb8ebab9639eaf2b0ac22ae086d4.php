      ...
      <div class="card col-md-8 col-md-offset-2">
        ...
        <div class="col-md-7 auth-right">
            <div class="row text-center">
              <a href="<?php echo e(route('login')); ?>"><img src="<?php echo e(asset('sitefront/auth-logo.png')); ?>"  alt="Invest Out Logo"></a>
            </div>
            <div class="row text-center">
              <h4>Login  to <span class='site-brand'><a href="<?php echo e(route('login')); ?>" class='no-hover'>InvestOut </a></span> Dashboard</h4>
            </div>
            <div class="row">
              <div class="col-md-12">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
                  ...
                  <input id="email" type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" placeholder="Email" value="<?php echo e(old('email')); ?>"  data-validation-engine="validate[required,custom[email]]" autofocus>
                  ...
                  <div style="position: relative;">
                    <input id="password" type="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" placeholder="Password" name="password"  data-validation-engine="validate[required]">
                  ...
                  <div class="row">
                   ...
                   <!--  <div class="col-md-7 dont-have-account">
                      <span>Do not have an account? <a href="<?php echo e(route('register')); ?>" class='signup-link'>Signup here</a></span>
                    </div> -->
                    <div class="col-md-7 dont-have-account" style="padding-top: 1em;">
                      <a href="<?php echo e(route('index')); ?>">Go to Homepage</a>
                    </div>
                  </div>
                </form>
              </div>
