                            ...
                            <form id="property_seller_suggested_offer">
                                <div class="<?php echo e($details->for_sale == '0' ? 'hide' : ''); ?>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            $ <span id="seller_askPrice"><?php echo e(number_format($details->investment_price) ?? '0'); ?></span>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 send-proposal-div">
                        ...
                        <form id="send_proposal" action="<?php echo e(route('seller.proposal.new_create')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url    : '<?php echo e(route("seller.investorProposals.list")); ?>',
            method : "POST",
