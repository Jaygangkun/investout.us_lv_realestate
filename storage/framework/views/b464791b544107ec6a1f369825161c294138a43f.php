          ...
          <div class="filter-is-visible"> 
            <div class="row" id="load-data">
                <?php $__currentLoopData = $properties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php $detail = $property->detail()->first(); ?>
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card-box-a card-shadow">
                            <div class="img-box-a">
                                <?php if(isset($property->images()->first()->image)): ?>
                                  <?php $image = $property->images()->first()->image; ?>
                                    <?php $__currentLoopData = $property->images()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($img->is_cover_image == 1): ?>
                                          <?php $image = $img->image; ?>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>   
                                  <img src="<?php echo e(asset('properties/'.$property->id.'/images/'.$image)); ?>" alt="" style="object-fit:cover;height: 450px;" class="img-a img-fluid">                              
                                <?php else: ?>
                                    <img src="<?php echo e(asset('property/assets/img/property-1.jpg')); ?>" alt="" style="height: 450px;" class="img-a img-fluid">
                                <?php endif; ?>                     
                            ...
                            <div class="card-overlay">
                                <div class="card-overlay-a-content">
                                    <div class="card-header-a">
                                        <!--<p>
                                          <a href="#" class="btn btn-primary" onclick="getOwnerDetails('<?php echo e($property->id); ?>'); return false;">
                                            <i class="fa fa-address-card" aria-hidden="true" title="View address"></i>
                                          </a>  
                                        </p>-->
                                        <div class="collapse" id="collapseExample<?php echo e($property->id); ?>">
                                    ...
                                    <div class="card-body-a">
                                        ...
                                        <a href="<?php echo e(route('property_single_page',['pid'=>$property->id])); ?>" class="link-a">  Click here to view <span class="ion-ios-arrow-forward"></span> </a>
                                    </div>
                                    <div class="card-footer-a">
                                        <ul class="card-info d-flex justify-content-around">
                                            <!--<li>
                                                <h4 class="card-info-title">Bed</h4>
                                                <span><?php echo e($property->bedroom); ?>

                                                </span>
                                            </li>
                                            <li>
                                                <h4 class="card-info-title">Floors</h4>
                                                <span><?php echo e($property->floors); ?></span>
                                            </li>
                                            <li>
                                                <h4 class="card-info-title">Sqr.Ft. </h4>
                                                <span><?php echo e($property->square_footage); ?></span>
                                            </li>-->
                                            <li>
                ...
                ?>
                  <div id="remove-row" class="rm-row col-md-12">
                      <button style="width: 15%;margin-bottom:40px;" data-id="<?php echo e($property->id); ?>" class="filter-data btn site-btn m-b-sm nounderline btn-block mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" > Load More </button>
                  </div>
                <?php
                }
                ?>
