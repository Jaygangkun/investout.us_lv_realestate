                ...
                <div class="panel-body">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab-1">
                      <a href="<?php echo e(route('admin.property.phase-index',0)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 0): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">New Properties</button></a>
                      <a href="<?php echo e(route('admin.property.phase-index',1)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 1): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Seller Validation</button></a>
                      <a href="<?php echo e(route('admin.property.phase-index',2)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 2): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Evaluation</button></a>
                      <a href="<?php echo e(route('admin.property.phase-index',3)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 3): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Title & liens Search</button></a>
                      <a href="<?php echo e(route('admin.property.phase-index',4)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 4): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Property Market Evaluation</button></a>
                      <a href="<?php echo e(route('admin.property.phase-index',5)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 5): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Approved</button></a>
                        ...
                        <tbody>
                          ...
                          <tr class="allproperty_row">
                            ...
                            <td class="client-avatar">
                              <a href="<?php echo e(route('admin.property.show',$property->propertiesID)); ?>">
                                <?php
                            ...
                            <td><?php echo e($property->seller['first_name']." ".$property->seller['last_name']); ?></td>
                            ...
                            <!--<td><input type="checkbox" <?php echo e(($property->in_active == "0")? "checked" : ""); ?> data-toggle="toggle" data-style="<?php echo e($property->propertiesID); ?>" id="is-active" data-on="Yes" data-off="No"></td>-->
                            <td>
                              <form action="<?php echo e(route('admin.property.update',$property->propertiesID)); ?>" method="post" id='form<?php echo e($key); ?>'>
                                ...
                                <select class="form-control" name="acceptance_level">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $select_label; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($k); ?>" <?php echo e($k==$property->acceptance_level ? 'selected="selected"' : ''); ?>><?php echo e($label); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </select>
                              </form>
                            </td>
                            ...
                            <td><a href="<?php echo e(route('admin.property.proposal.list',['property_id'=>$property->propertiesID])); ?>" class="proposal-count-info"><i class="fa fa-list-alt" style="font-size:21px;color: #36b394;" aria-hidden="true"></i></a></td>
