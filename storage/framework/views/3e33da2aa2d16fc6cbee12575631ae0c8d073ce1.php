                                                      ...
                                                      <tbody>
                                                              <?php $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td><a href="<?php echo e(route('realtors.property.show',$proposal->property_id)); ?>"><?php echo e($proposal->property_id); ?> </a></td>
                                                                      <td><?php echo e(date('d-M-Y', strtotime($proposal->created_at))); ?></td>
                                                                      <td>
                                                                        <form action="<?php echo e(route('realtors.proposal.update')); ?>" method='post'>
                                                                            <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <td>
                                                                        <?php echo Form::open(['method' => 'post', 'route' => ['realtors.proposal.update'], 'class' => 'form-horizontal denyForm']); ?>
