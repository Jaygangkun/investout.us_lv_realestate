...
<?php $__env->startSection('body'); ?>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        ...
                        <div class="breadcrumb-option">
                            <a href="<?php echo e(url('/')); ?>"><i class="fa fa-map"></i> Home</a>
                            <span>Envoy</span>
                        </div>
                    </div>
                </div>
    ...
    <section class="hero-section">
        <div>
            <div style="border-top:15px #002060 solid;border-bottom:15px #002060 solid">
                <div class="row">
                    <div class="col-lg-4">
                        <img src="<?php echo e(asset('assets/front_end/img/envoy/Picture2.png')); ?>" style="width: 100%" alt=""
                             height="auto">
                    </div>
                    <div class="col-lg-8">
                        <img src="<?php echo e(asset('assets/front_end/img/envoy/Picture1.png')); ?>" style="width: 100%;"
                             height="auto">
                    </div>
                </div>
            </div>
    ...
    <section class="howit-works spad">
        <div class="row">
            <div class="col-lg-12" style="padding: 0px;">
                <div class="section-title">
                    <img src="<?php echo e(asset('affiliate/2.png')); ?>" alt="How it Works">
    ...
    <div class="video-section set-bg" data-setbg="<?php echo e(asset('assets/front_end/img/envoy/Picture3.png')); ?>"
         style="background-image: url(<?php echo e(asset('assets/front_end/img/envoy/Picture3.png')); ?>);">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <form action="<?php echo e(route('inquiry.store')); ?>" method="post" id="formID"
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class='image-section'>
                        <img src="<?php echo e(asset('assets/front_end/img/envoy/Picture6.png')); ?>" alt="">
                    </div>
                </div>
                    ...
                    <div class="col-lg-3 col-md-10 form-box" style='margin-left:2.5%; margin:0 auto;'>
                        <div class="col-xl-12" style="background-color:#1B2638;height: 60px;display: table;">
                            <p style="color:#ffff; text-align:center; vertical-align: middle; display: table-cell;">
                                Create Inquiry</p>
                            <?php echo $__env->make('admin.includes.notifications', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
    ...
    <div style="display: flex; flex-direction: column; -webkit-font-smoothing: antialiased; display: none"
        ...
        <div class="col-md-12" style="text-align: center;">
            <img style="width: 50%;margin: 20px 0px;" src="<?php echo e(asset('assets/front_end/img/envoy/Envoy_Logo_final.png')); ?>">
        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <link href="<?php echo asset('assets/user/css/new.css'); ?>" rel="stylesheet" type="text/css"/>
    <link href="<?php echo asset('assets/user/css/style.css'); ?>" rel="stylesheet" type="text/css"/>
    <script src="https://api.mapbox.com/mapbox-gl-js/v2.0.0/mapbox-gl.js"></script>
    <script src="<?php echo asset('assets/user/js/fullcalendar/moment.min.js'); ?>"></script>
    <script src="<?php echo asset('assets/user/js/fullcalendar/fullcalendar.min.js'); ?>"></script>
    <script src="<?php echo asset('assets/user/js/fullcalendar/locale-all.js'); ?>"></script>
    ...
    <script>
        ...
        $.ajax({
            url: '<?php echo e(route('envoy.state-name')); ?>',
            type: "get",
            dataType: "json",
            async: false,
        ...
        $(document).ready(function () {
            ...
            $('#calendar').fullCalendar({
                ...
                events: function (start, end, timezone, callback) {
                    $.ajax({
                        url: '<?php echo e(route('reservation.calendar')); ?>',
                        dataType: 'json',
                        cache: false,
                        data: {
                ...
                eventClick: function (date, info) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('booking.slots')); ?>",
                        type: 'post',
                        dataType: 'json',
                        data: {
                            date: start,
            ...
            $('#stateName').change(function () {
                ...
                $.ajax({
                        url: '<?php echo e(route('envoy.city-name')); ?>',
                        type: "post",
            ...
            $('#cityName').change(function () {
                city_name = $(this).val();
                $.ajax({
                    url: '<?php echo e(route('envoy.coordinates')); ?>',
                    type: "POST",
                    ...
                    success: async function (data) {
                        ...
                        mapboxglMap.on('click', 'places', function (e) {
                            ...
                            $.ajax({
                                url: '<?php echo e(route('get_data.zip')); ?>',
                                data: {
                                    zip: zipcode,
                                    "_token": "<?php echo e(csrf_token()); ?>"
                                },
