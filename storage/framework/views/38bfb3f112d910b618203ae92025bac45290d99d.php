                        ...
                        <div class="property-price d-flex justify-content-center foo">
                            <div class="card-header-c d-flex">
                                <div class="card-title-c align-self-center">
                                    <h5>Asking Price</h5>
                                    <h5 class="title-c">$ <span class="priceNew" id="seller_ask_price"><?php echo e(number_format($details->investment_price) ?? '0'); ?></span></h5>
                                </div>
                            </div>
                        </div>
                    </div> -->
                            ...
                            <form id="property_seller_suggested_offer">
                                ...
                                <div class="<?php echo e($details->partner_up == '0' ? 'hide' : ''); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <span id="seller_partnership_seller"><?php echo e($details->partnership_seller ?? '0'); ?></span> %
                                            </div>
                                        <label for="arv" class="col-sm-3 col-form-label">Investor's Profit Share(%)</label>
                                        <div class="col-sm-3">
                                            <span id="seller_partnership_investor"><?php echo e($details->partnership_investor ?? '0'); ?></span> %
                                            </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="arv" class="col-sm-3 col-form-label">Contract Start Date</label>
                                        <div class="col-sm-3">
                                            <span ><?php echo e(Carbon\Carbon::parse($property->contract_start)->format('m/d/Y')); ?></span>

                                        </div>
                                        <label for="arv" class="col-sm-3 col-form-label">Contract End Date</label>
                                        <div class="col-sm-3">
                                            <span ><?php echo e(Carbon\Carbon::parse($property->contract_end)->format('m/d/Y')); ?></span>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 send-proposal-div">
                        ...
                        <form id="send_proposal" action="<?php echo e(route('whole-seller.proposal.new_create')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <input type="hidden" class="form-control" id="to_user" name="to_user" value="<?php echo e($investor->id); ?>">
                            ...
                            <input type="hidden" class="form-control" id="holding_cost" name="holding_cost" value="<?php echo e($details->holding_cost); ?>">
                            <input type="hidden" class="form-control" id="resale_fees" name="resale_fees" value="<?php echo e($details->resale_fees); ?>">
                            <input type="hidden" class="form-control" id="loan_cost" name="loan_cost" value="<?php echo e($details->loan_cost); ?>">
                            <input type="hidden" class="form-control" id="rule_percentage" name="rule_percentage" value="<?php echo e($details->rule_percentage); ?>">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url    : '<?php echo e(route("whole-seller.investorProposals.list")); ?>',
                method : "POST",
                data : {id:property_id, investor_id: investor_id, _token:"<?php echo e(csrf_token()); ?>"},
                dataType : "text",
                success : function (responses)
                {
                    var response = JSON.parse(responses);
        ...
        $(document).on("click", "a[id^='accept_proposal_']", function(){
            ...
            $.ajax({
                url: '<?php echo e(route("seller.proposal.setAccept")); ?>',
                method: 'POST',
                data: { id: proposal_id[2], _token:"<?php echo e(csrf_token()); ?>" },
                dataType: 'json',
                success: function(response)
                {
                    if(response.status)
