    ...
    <nav class="navbar navbar-inverse custom-navbar  navbar-fixed-top">
        <div class="container-fluid ">
            ...
            <span class="icon-bar"></span>
                ...
                <a class="navbar-brand custom-navbar-brand" href="<?php echo e(route('brokeragehouse.index')); ?>">
                <img class="colaborator-logo-inline header-circle-img" src="<?php echo e(asset('sitefront/log.png')); ?>" style='width:auto'>
          </a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info-user-img" data-toggle="dropdown" href="">
                            <img alt="image" class="img-circle header-circle-img" src="<?php echo e(asset('profilepic/'.session('profile')->image)); ?>">
                            <span><?php echo e($user->name()); ?></span>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(route('brokeragehouse.showprofile')); ?>">View Your Profile</a></li>
                            <li><a href="<?php echo e(route('brokeragehouse.editprofile')); ?>">Edit Your Profile</a></li>
                            <li><a href="<?php echo e(route('brokeragehouse.billingDetails')); ?>">Billing Details</a></li>
                            <li><a href="<?php echo e(route('brokeragehouse.changepassword')); ?>">Change Password</a></li>
                            <li class="divider"></li>
                            <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu notification-alerts count-info-notification" id='notification-alerts'>
                            <li>
                                <a href='#' class='noti-link'>
                                    <div class="col-md-3 text-left msg-alert-pic" style='padding:0px'>
                                    </div>
