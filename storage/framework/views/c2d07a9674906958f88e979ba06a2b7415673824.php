                                          ...
                                          <div class="tab-content">
                                              ...
                                              <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $subscriptions->plan_name; ?></td>
                                                        ...
                                                        <td><a href="#" onclick="getPackage('<?php echo e($subscriptions->plan_id); ?>')"><i class="fa fa-eye"></i></a></td>
                                                        <td><a href="<?php echo e($subscriptions->pdf_link); ?>" target="_blank">View Invoice</a></td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
          ...
          <div id="cancelSubscriptionModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <a href="<?php echo e(route('investors.cancelSubscription')); ?>" class="btn btn-primary">Cancel Subscription</a>
                </div>
...
<script type="text/javascript">
    function getPackage(planid){
        ...
        $('.ViewFeatures').html("");
        $.ajax({
            url: "<?php echo e(ENV('APP_URL')); ?>/get-user-plan-detail-by-plan-id?planid="+planid,
            type: 'GET',
            dataType: 'json',
