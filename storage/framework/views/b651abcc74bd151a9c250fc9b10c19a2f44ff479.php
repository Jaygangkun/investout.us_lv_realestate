      ...
      <div class="col-lg-12">
        <div class="ibox float-e-margins">
          ...
          <?php if($add_property_allowance == false): ?>
            ...
            <a class="btn btn-primary dim" href="<?php echo e(route('upgradeSub')); ?>">Upgrade your subscription</a>
          <?php endif; ?>
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr class="allproperty_row <?php echo e($property->acceptance_level == 5 ? 'approved-property' : ''); ?>">
                            ...
                            <td><a href="<?php echo e(route('whole-seller.proposal.list',['property_id'=>$property->propertiesID])); ?>" class="proposal-count-info"><i class="fa fa-list-alt" style="font-size:21px;color: #36b394;" aria-hidden="true"></i><span class="label lab1 label-warning"><?php echo e($property->unread_proposals); ?></span></a></td>
