                ...
                <div class="panel-body">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="tab-1">
                      <a href="<?php echo e(route('investors.property.phase-index',0)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 0): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">New Properties</button></a>
                      <a href="<?php echo e(route('investors.property.phase-index',1)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 1): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Seller Validation</button></a>
                      <a href="<?php echo e(route('investors.property.phase-index',2)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 2): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Evaluation</button></a>
                      <a href="<?php echo e(route('investors.property.phase-index',3)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 3): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Title & liens Search</button></a>
                      <a href="<?php echo e(route('investors.property.phase-index',4)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 4): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Property Market Evaluation</button></a>
                      <a href="<?php echo e(route('investors.property.phase-index',5)); ?>"><button type="button" class='btn apply-button' <?php if($phase == 5): ?> style='background: #1ab394;border: 1px solid #1ab394;' <?php endif; ?> name="button">Approved</button></a>
                        ...
                        <tbody>
                          ...
                          <tr class="allproperty_row">
                            ...
                            <td class="client-avatar">
                              <a href="<?php echo e(route('investors.property.show',$property->propertiesID)); ?>">
                                <?php
