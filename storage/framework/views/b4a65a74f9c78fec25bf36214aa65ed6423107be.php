...
<?php $__env->startSection('style'); ?>
  <link href="<?php echo e(asset('css/circle.css')); ?>" rel="stylesheet">
                      ...
                      <div class="">
                          <div class="row vertical-align">
                              ...
                              <div class="col-xs-9 text-right">
                                  <h2 class="innerhead">Total User <br> <?php echo e($total_user); ?></h2>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-12 statistics">
                      <div class="">
                          <div class="row vertical-align">
                              ...
                              <div class="col-xs-9 text-right">
                                  <h2 class="innerhead">Total Property <br> <?php echo e($total_properties); ?></h2>
                              </div>
                          </div>
                      </div>
                  </div>
                      ...
                      <div class="">
                          <div class="row vertical-align">
                              ...
                              <div class="col-xs-9 text-right" style='padding-left:0px'>
                                  <h2 class="innerhead">Total Completed <br> <?php echo e($total_completedCount); ?></h2>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-12 statistics">
                      <div class="">
                          <div class="row vertical-align">
                              ...
                              <div class="col-xs-9 text-right">
                                  <h2 class="innerhead">Processing <br> <?php echo e($total_active); ?></h2>
                              </div>
                          </div>
                      </div>
                  </div>
                ...
                <div class="col-lg-12">
                  <div class="col-md-4 stats" style='padding:0px'>
                    ...
                    <div class="col-md-5" style='padding:0px;padding-top:3em;'>
                      <h2 class='head1 no-margins'><?php echo e($month_totalproperty); ?></h2>
                  ...
                  <div class="col-md-4 stats" style='padding:0px'>
                    ...
                    <div class="col-md-5" style='padding:0px;padding-top:3em;'>
                      <h2 class='head1 no-margins'><?php echo e($month_totalcomplete); ?></h2>
                  ...
                  <div class="col-md-4 stats" style='padding:0px'>
                    ...
                    <div class="col-md-5" style='padding:0px;padding-top:3em;'>
                      <h2 class='head1 no-margins'><?php echo e($month_totalactivity); ?></h2>
