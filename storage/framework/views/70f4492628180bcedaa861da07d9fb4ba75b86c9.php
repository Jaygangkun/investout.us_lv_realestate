                  ...
                  <div class="col-lg-12">
                      <div class="ibox float-e-margins">
                          <div class="ibox-title">
                               <h2 style='color:#0b2a4a;font-family:unisansboldbold;font-weight:100'><b style='font-weight:100;text-transform:capitalize'>New Proposals</b></h2>
                          </div>
                                                      ...
                                                      <tbody>
                                                              <?php $__currentLoopData = $proposals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$proposal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td>
                                                                        <form action="<?php echo e(route('admin.proposal.approve')); ?>" method='post'>
                                                                            <?php echo csrf_field(); ?>
                                                                            <input type="hidden" name='pro_id' value=<?php echo e($proposal->id); ?>>
                                                                            <button type="submit" class='btn btn-primary form-submit' name="button" ><i class='fa fa-save'></i> Approve</button>
                                                                        </form>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo Form::open(['method' => 'post', 'route' => ['admin.proposal.deny'], 'class' => 'form-horizontal denyForm']); ?>
