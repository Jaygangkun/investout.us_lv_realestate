                                                      ...
                                                      <tbody>
                                                              <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                  <tr class="allproperty_row">
                                                                      ...
                                                                      <td  class="client-avatar"><a href ="<?php echo e(route('profile.show',['user',$user->id])); ?>"><img alt="image" src="<?php echo e(asset('profilepic/'.$user->profile->image)); ?>"> </a>
                                                                      </td>
                                                                      ...
                                                                      <td>
                                                                        <a href="<?php echo e(route('profile.show',['user',$user->id])); ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>&nbsp;
                                                                        <a href="<?php echo e(route('admin.users.edit_other_admin_profile', [$user->id])); ?>" class="btn btn-success" data-user_id="<?php echo e($user->id); ?>"><i class="fa fa-pencil"></i></a>&nbsp;
              ...
              <div class="modal-dialog adminRegistration">
                  <div class="modal-content animated fadeIn">
                      ...
                      <div class="modal-body">
                          <form class="m-t" role="form" action="<?php echo e(route('admin.users.admin-create')); ?>" id="adminRegistration" method="POST">
