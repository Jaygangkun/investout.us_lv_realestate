                                        ...
                                        ?>
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="zip" class='form-control validate[required]' id="">
                                                    <?php $__currentLoopData = $assignedZipcodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignedZipcode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if(isset($edit_properties) && $edit_properties->zip == $assignedZipcode): ?>
                                                            <option value='<?php echo e($assignedZipcode); ?>' selected><?php echo e($assignedZipcode); ?></option>
                                                        <?php else: ?>
                                                            <option value='<?php echo e($assignedZipcode); ?>'><?php echo e($assignedZipcode); ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <small class="text-danger"><?php echo e($errors->first('zip')); ?></small>
                                                ...
                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php $__currentLoopData = $all_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($role->id == $user->role_id): ?>
                                                            <option value="<?php echo e($user->id); ?>" data-subtext="<?php echo e($user->email); ?>" <?php echo app('request')->input('pid') && $edit_properties->user_id == $user->id ? "selected" : auth()->user()->id == $user->id ? "selected" : "";?>><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </optgroup>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="step-2">
                                    ...
                                    <div class="form-row partner_up_row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon" id="basic-addon1">$</span>
                                                <input type="text" name='brv_price' id='brv_price' value='<?php echo e($details->brv_price ?? ""); ?>' class='form-control amountComma validate[min[0],maxSize[10]]'>
                                            </div>
                                    ...
                                    <div class="form-row seller_profit_share partner_up_row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            ?>
                                            <div class="input-group">
                                                <input type="text" name="partnership_seller" id="partnership_seller" value='<?php echo e($details->partnership_seller ?? "0"); ?>' id="partnership_seller" class="form-control validate[required,maxSize[2]]">
                                                <span class="input-group-addon" id="basic-addon1">%</span>
                                            </div>
