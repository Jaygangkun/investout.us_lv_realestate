...
<link rel="stylesheet" href="<?php echo e(asset('property/assets/vendor/ionicons/css/ionicons.min.css')); ?>" type="text/css">
<link rel="stylesheet" href="<?php echo e(asset('property/assets/vendor/animate.css/animate.min.css')); ?>" type="text/css">
<link rel="stylesheet" href="<?php echo e(asset('property/assets/vendor/owl.carousel/assets/owl.carousel.min.css')); ?>" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="<?php echo e(asset('property/assets/css/style.css')); ?>" rel="stylesheet" type="text/css">
<style>
  .quicksummary{
    background: #f6f6f6;
    padding: 15px;
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              ...
              <span class="color-text-a"><h5><?php echo e($property->address ?? '-'); ?><?php echo e($property->city ?? '-'); ?>, <?php echo e($property->state ?? '-'); ?> <?php echo e($property->zip ?? '-'); ?></h5></span>
            </div>
          </div>
            ...
            <div class="property-price d-flex justify-content-center foo">
              <div class="card-header-c d-flex">
                <div class="card-title-c align-self-center">
                  <h5>Asking Price</h5>
                  <h5 class="title-c">$ <span class="priceNew"><?php echo e($details->investment_price ?? '0'); ?></span></h5>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
                ...
                ?>
                    ...
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if($img['is_cover_image'] == 1): ?> 
                        ...
                        <div class="carousel-item-b">
                          <img src="<?php echo e(asset('properties/'.$property->id.'/images/'.$img->image)); ?>" alt="">
                        </div>
                      <?php endif; ?>
                  ...
                  <!-- <div class="carousel-item-b">
                    <img src="<?php echo e(asset('property/assets/img/slide-2.jpg')); ?>" alt="">
                </div>
                <div class="carousel-item-b">
                  <img src="<?php echo e(asset('property/assets/img/slide-3.jpg')); ?>" alt="">
                </div>
                <div class="carousel-item-b">
                  <img src="<?php echo e(asset('property/assets/img/slide-1.jpg')); ?>" alt="">
                </div> -->
                  ...
                  <div class="summary-list">
                    <ul class="list">
                      <li class="d-flex justify-content-between">
                        ...
                        <span><?php echo e($property->id ?? '-'); ?></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Location:</strong>
                        <span><?php echo e($property->city ?? '-'); ?>, <?php echo e($property->state ?? '-'); ?> <?php echo e($property->zip ?? '-'); ?></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Property Type:</strong>
                        <span><?php echo e($details['property_type']); ?></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Bedroom:</strong>
                        <span><?php echo e($details->bedroom ?? '-'); ?></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>Bathroom:</strong>
                        <span><?php echo e($details->bathroom ?? '-'); ?>

                        </span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>SqarFt.</strong>
                        <span><span class="priceNew"><?php echo e($details->square_footage ?? '-'); ?></span></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>BRV Price</strong>
                        <span>$ <span class="priceNew"><?php echo e($details->brv_price ?? '-'); ?></span></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>ARV Price :</strong>
                        <span>$ <span class="priceNew"><?php echo e($details->arv_price  ?? '-'); ?></span></span>
                      </li>
                      <li class="d-flex justify-content-between">
                        <strong>For Sale :</strong>
                        <span><?php echo e((isset($details->for_sale) && $details->for_sale == 1)  ? 'Yes' : 'No'); ?></span>
                      </li>
                      <?php
                      ...
                      ?>
                        <li class="d-flex justify-content-between" style="position: relative;">
                          ...
                          <span>$ <span class="priceNew"><?php echo e($details->investment_price); ?></span></span>
                        </li>
                      <?php
                      }
                      ?>
                      <li class="d-flex justify-content-between">
                        ...
                        <span><?php echo e((isset($details->partner_up) && $details->partner_up == 1)  ? 'Yes' : 'No'); ?></span>
                      </li>
                      <?php
                      ...
                      ?>
                        <li class="d-flex justify-content-between" style="position: relative;padding-top: 25px;">
                          ...
                          <span><?php echo e($details->partnership_seller); ?>/<?php echo e($details->partnership_investor); ?>%</span>
                        </li>
                        <li class="d-flex justify-content-between">
                          <strong>Estimated Repair Cost</strong>
                          <span>$ <span class="priceNew"><?php echo e($details->estimated_repair_cost ?? '-'); ?></span></span>
                        </li>
                      <?php
                      }
                      ?>
                      <!--<li class="d-flex justify-content-between OwnerDetailsClass">
                        ...
                        <a class="btn btn-primary" href="#" onclick="getOwnerDetails('<?php echo e($property->id); ?>'); return false;"><i class="fa fa-address-card" aria-hidden="true" title="Owner Details"></i></a>
                      </li>-->
                    </ul>
                  </div>
                </div>
          ...
          <div class="col-md-10 offset-md-1">
            ...
            <div class="tab-content" id="pills-tabContent" style="padding-bottom: 3rem;">
              ...
              <div class="tab-pane fade  show active" id="pills-plans" role="tabpanel" aria-labelledby="pills-plans-tab">
                <img src="<?php echo e(asset('property/assets/img/plan2.jpg')); ?>" alt="" class="img-fluid">
              </div>
              <div class="tab-pane fade" id="pills-map" role="tabpanel" aria-labelledby="pills-map-tab">
                <!--<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.1422937950147!2d-73.98731968482413!3d40.75889497932681!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25855c6480299%3A0x55194ec5a1ae072e!2sTimes+Square!5e0!3m2!1ses-419!2sve!4v1510329142834" width="100%" height="460" frameborder="0" style="border:0" allowfullscreen></iframe>-->
                <div id="map" style="height: 450px;"></div>
                
                <!--<iframe width="100%" height="460" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=<?php echo e($property->address); ?>,<?php echo e($property->city); ?>,<?php echo e($property->state); ?>&amp;output=embed"></iframe><br />-->

                <!--<iframe src="https://www.google.com/maps/embed/v1/place?q=<?php echo e($property->lat); ?>,<?php echo e($property->long); ?>&amp;key=AIzaSyBIwzALxUPNbatRBj3Xi1Uhp0fFzwWNBkE" width="100%" height="460" frameborder="0" style="border:0" allowfullscreen>-->
              </div>
            </div>
          </div>          
        </div>
