...
<?php $__env->startSection('body'); ?>
    ...
    <?php $details = $property->detail()->first(); ?>
    <!-- ======= Intro Single ======= -->
        ...
        <section class="intro-single">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <div class="title-single-box">
                            ...
                            ?>
                            <h1 class="title-single"><?php echo e($title); ?></h1>
                            <div class="color-text-a">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <h5>: <?php echo e($property->address ?? '-'); ?>, <?php echo e($property->city ?? '-'); ?>, <?php echo e($property->state ?? '-'); ?> <?php echo e($property->zip ?? '-'); ?></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-9">
                                        <h5><?php echo e(Carbon\Carbon::parse($property->contract_start)->format('m/d/Y')); ?></h5>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                ...
                                <?php if(isset($accepted_proposal) && $accepted_proposal->is_accepted == 1 && ($accepted_proposal->from_user == auth()->user()->id || $accepted_proposal->to_user == auth()->user()->id)): ?>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h5>Owner's Details</h5>
                                        </div>
                                        <div class="col-md-9">
                                            <h5 onclick="getOwnerDetails('<?php echo e($property->id); ?>'); return false;"><i class="glyphicon glyphicon-phone-alt" aria-hidden="true" title="Owner Details"></i></h5>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
                    ...
                    <div class="property-price d-flex justify-content-center foo">
                        <div class="card-header-c d-flex">
                            <div class="card-title-c align-self-center">
                                <h5>Asking Price</h5>
                                <h5 class="title-c">$ <span class="priceNew" id="seller_ask_price"><?php echo e(($details->investment_price) ?? '0'); ?></span></h5>
                            </div>
                        </div>
                    </div>
                </div>-->
                ...
                <div class="row">
                    ...
                    ?>
                    <input type="hidden" id="seller_ask_price" value="<?php echo e(($details->investor_asking) ?? '0'); ?>" name="seller_ask_price"/>
                    <div class="col-sm-3 hide">
                        $ <span id="seller_brv"><?php echo e((number_format($details->brv_price)) ?? '0'); ?></span>
                    </div>

                    <div class="col-md-12">
                        <div class="title-single-box">
                            <form id="property_seller_suggested_offer">
                                <div class="<?php echo e($details->for_sale == '0' ? 'hide' : ''); ?>">
                                    ...
                                    <!-- <?php echo $roleName; ?>'s Suggested Ask Price -->
                                        <div class="col-sm-3">
                                            $ <span id="seller_askPrice"><?php echo e((number_format($details->investor_asking)) ?? '0'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <hr class="<?php echo e($details->for_sale == '1' && $details->partner_up == '1' ? '' : 'hide'); ?>">
                                <div class="<?php echo e($details->partner_up == '0' ? 'hide' : ''); ?>">
                                    <div class="form-group row">
                                        <label for="arv" class="col-sm-3 col-form-label"><?php echo $roleName; ?>'s Estimated ARV Selling Price</label>
                                        <div class="col-sm-3">
                                            $ <span id="seller_arv"><?php echo e((number_format($details->arv_price)) ?? '0'); ?></span>
                                        </div>
                                        <?php
                                        if($property->seller()->first()->roles()->first()->slug == 'wholeseller')
                                        {
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            $ <span id="seller_est_repair_cost"><?php echo e((number_format($details->estimated_repair_cost)) ?? '0'); ?></span>
                                        </div>
                                        <label for="arv" class="col-sm-3 col-form-label">Investor's Projected Profit</label>
                                        <div class="col-sm-3">
                                            $ <span id="investor_projected_profit"><?php echo e(number_format($details->investor_projected_profit) ?? '0'); ?></span>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        ?>
                                            ...
                                            ?>
                                        <div class="col-sm-3">
                                            $ <span id="seller_partnership_seller_amount"><?php echo e(number_format($details->wholeseller_profit) ?? '0'); ?></span>
                                            <span class="hide" id="seller_partnership_seller"><?php echo e($details->partnership_seller); ?></span>
                                        </div>
                                            <?php
                                            }
                                            ?>
                                        ...
                                        <div class="col-sm-3">
                                            $ <span id="estimated_misc_cost"><?php echo e(number_format(floatval($details->holding_cost)+floatval($details->resale_fees)+floatval($details->loan_cost)) ?? '0'); ?></span>
                                            <span class="hide" id="seller_partnership_investor"><?php echo e($details->partnership_investor ?? '0'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 send-proposal-div">
                        ...
                        <form id="send_proposal" action="<?php echo e(route('investors.proposal.new_create')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" class="form-control" id="property_id" name="property_id" value="<?php echo e($property->id); ?>">
                            <input type="hidden" class="form-control" id="from_user" name="from_user" value="<?php echo e(auth()->user()->id); ?>">
                            <input type="hidden" class="form-control" id="to_user" name="to_user" value="<?php echo e($property->user_id); ?>">
                            ...
                            <div class="row <?php echo e($details->for_sale == '0' ? 'hide' : ''); ?>">
                                <div class="col-md-12">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <small class="text-danger"><?php echo e($errors->first('ask_price')); ?></small>
                                </div>
                            </div>
                            <hr class="<?php echo e($details->for_sale == '1' && $details->partner_up == '1' ? '' : 'hide'); ?>">
                            <div class="row <?php echo e($details->partner_up == '0' ? 'hide' : ''); ?>">
                                <?php
                                if($property->seller()->first()->roles()->first()->slug != 'wholeseller')
                                {
                                ?>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="text-danger"><?php echo e($errors->first('arv')); ?></small>
                                </div>
                                <!-- <div class="form-group col-md-3">
                                    ...
                                    <small class="text-danger"><?php echo e($errors->first('brv')); ?></small>
                                </div> -->
                                <input type="hidden"  class='form-control amountComma' min="0" max="10000000" name='brv_range_value' id='brv_range_value' data-id='brv'>
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="text-danger"><?php echo e($errors->first('est_repair_cost')); ?></small>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="70_rule">70% Rule: </label>
                                    <div class="input-group">
                                        <span class="input-group-addon" id="basic-addon1">%</span>
                                        <input type="number" min="50" max="80" name='rule_percentage' id='rule_percentage' value='<?php echo e($details->rule_percentage && intval($details->rule_percentage)>0?intval($details->rule_percentage): "70"); ?>' class='form-control  validate[min[50],max[90]]'>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="holding_cost" id="holding_cost" value='<?php echo e(number_format($details->holding_cost) ?? "0"); ?>' class="amountComma form-control validate[required,min[0],maxSize[10]]">
                                        <span class="input-group-addon" id="basic-addon1">$</span>
                                    </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="resale_fees" name="resale_fees" value='<?php echo e(number_format($details->resale_fees) ?? "0"); ?>' class="amountComma form-control validate[required,min[0],maxSize[10]]">
                                        <span class="input-group-addon" id="basic-addon1">$</span>
                                    </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="loan_cost" id="loan_cost" value='<?php echo e(number_format($details->loan_cost) ?? "0"); ?>' id="loan_cost" class="amountComma form-control validate[required,min[0],maxSize[10]]">
                                        <span class="input-group-addon" id="basic-addon1">$</span>
                                    </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="total_misc_cost" id="total_misc_cost"  class="form-control validate[required]" value="<?php echo e(number_format(floatval($details->holding_cost)+floatval($details->resale_fees)+floatval($details->loan_cost))); ?>" disabled placeholder="Calculated">
                                        <span class="input-group-addon" id="basic-addon1">$</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row <?php echo e($details->partner_up == '0' ? 'hide' : ''); ?>">
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="text-danger"><?php echo e($errors->first('seller_share')); ?></small>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="text-danger"><?php echo e($errors->first('investor_share')); ?></small>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        <input readonly type="text" class="form-control" min="1"  name='wholeseller_offer' id='wholeseller_offer' value="<?php echo e($details->investor_asking); ?>" data-id='investor_share'>
                                        <span class="input-group-addon" id="basic-addon1">$</span>
                                    </div>
                            ...
                            <div class="row hide <?php echo e($details->partner_up == '0' ? 'hide' : ''); ?>">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo asset('assets/user/js/fullcalendar/moment.min.js'); ?>"></script>
    ...
    <script>
        function getOwnerDetails(id) {
            ...
            $("#Details").html("");
            $.ajax({
                url    : '<?php echo e(route("getOwnerDetails")); ?>',
                method : "POST",
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url    : '<?php echo e(route("investors.property.propertyProposalsList")); ?>',
                method : "POST",
                data : {id:property_id, _token:"<?php echo e(csrf_token()); ?>"},
                dataType : "text",
                success : function (responses)
                {
                    var response = JSON.parse(responses);
                        ...
                        $('#seller_gross_profit').val(numberWithCommas(seller_gross_profit));
                            ...
                            if(<?php echo $details->for_sale;?> != 0)
                            {
                                if(<?php echo $details->partner_up;?> == 0)
                                {
                                    ...
                                    {
                                        html += '<a download href="<?php echo e(asset("proposal")); ?>/'+ value.document+'">'
        ...
        $(document).on("show.bs.collapse", ".collapse", function (event) {
            ...
            if ($(this).siblings('.proposal_received').length || ($(this).siblings('.best_deal').length && $(this).siblings('.best_deal').attr("data-type") === "received")) {
                $.ajax({
                    url: '<?php echo e(route("proposal.setRead")); ?>',
                    method: 'POST',
                    data: { id: proposal_id[1], _token:"<?php echo e(csrf_token()); ?>" },
                    dataType: 'json',
    ...
    <script>
        ...
        function initMap() {
            const mapOptions = {
                zoom: 12,
                center: { lat: <?php echo e($property->lat); ?>, lng: <?php echo e($property->long); ?> },
            };
            map = new google.maps.Map(document.getElementById("map"), mapOptions);
            const marker = new google.maps.Marker({
                // The below line is equivalent to writing:
                // position: new google.maps.LatLng(<?php echo e($property->lat); ?>, <?php echo e($property->long); ?>)
                position: { lat: <?php echo e($property->lat); ?>, lng: <?php echo e($property->long); ?> },
                map: map,
            });
