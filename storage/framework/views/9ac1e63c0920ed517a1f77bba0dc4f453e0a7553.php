...
<!-- Breadcrumb Section Begin -->
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="<?php echo e(asset('assets/front_end/img/seller/seller.jpg')); ?>">
            </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Process</h2>
                        <img src="<?php echo e(asset('assets/front_end/img/old/Infographics_ b.png')); ?>" alt="How it Works">
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="container text-center">
        <img src="<?php echo e(asset('assets/front_end/img/BeforeAfterSeller.png')); ?>">
    </div>
    <div class="container text-center">
        ...
        <table class="table table-borderless">
            <tbody>
                ...
                <tr>
                    ...
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td style="min-width: 140px;"><a target="_blank" href="<?php echo e(config('app.basepath.APP_URL')); ?>register?plan=<?php echo e($plan->plan_id); ?>" class="btn btn-primary btn-block">Sign Up</a></td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tr>
            </tbody>
        </table>
    ...
    <div class="text-center">
        <img src="<?php echo e(asset('assets/front_end/img/seller/seller.png')); ?>">
    </div>
