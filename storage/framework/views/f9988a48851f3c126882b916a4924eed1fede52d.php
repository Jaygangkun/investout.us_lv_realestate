...
<!-- Breadcrumb Section Begin -->
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single-blog-item">
                        <div class="sb-pic">
                            <img src="<?php echo e(asset('assets/front_end/img/investor/before.png')); ?>" alt="image">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single-blog-item">
                        <div class="sb-pic">
                            <img src="<?php echo e(asset('assets/front_end/img/investor/after.png')); ?>" alt="image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="howit-works spad">
        <div class="row">
            <div class="col-lg-12" style="padding: 0px;">
                <div class="section-title">
                    <img src="<?php echo e(asset('affiliate/3.png')); ?>" alt="How it Works">
    ...
    <div class="container text-center">
        <img src="<?php echo e(asset('assets/front_end/img/BeforeAfterInvestor.png')); ?>">
    </div>
    <div class="container text-center">
        ...
        <table class="table table-borderless">
            <tbody>
                ...
                <tr>
                    ...
                    <?php $i = 0;  ?>
                    <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td><a target="_blank" href="<?php echo e(config('app.basepath.APP_URL')); ?>register?plan=<?php echo e($plan->plan_id); ?>" class="btn btn-primary btn-block">Sign Up</a></td>
                    <?php $i++;  ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tr>
            </tbody>
    ...
    <div class="text-center">
        <img src="<?php echo e(asset('assets/front_end/img/investor/investor.png')); ?>">
    </div>
