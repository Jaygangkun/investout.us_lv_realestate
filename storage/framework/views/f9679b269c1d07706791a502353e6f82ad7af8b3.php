            ...
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class='text-center'>
                      <a href="<?php echo e(route('seller.index')); ?>">
                    ...
                    <li>
                        <a class="<?php echo e(request()->is('investor-propertys') ? 'active' : ''); ?>" href="<?php echo e(route('seller.index')); ?>"><i class="fa fa-dashboard" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('seller.property.phase-index',5)); ?>" class=""><i class="fa fa-cubes"></i> <span class="nav-label">My Properties</span></a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo e(route('seller.proposal.show')); ?>"> <span class="nav-label">Received Proposals</span></a></li>
                            <li><a href="<?php echo e(route('seller.proposal.approved.show')); ?>"> <span class="nav-label">Accepted Proposals</span></a></li>
                            <!-- <li><a href="<?php echo e(route('seller.proposal.denied.show')); ?>"> <span class="nav-label">Denied Proposals</span></a></li> -->
                        </ul>
                    </li>
                    <li>
                    ...
                    <!--<li>
                        <a class="<?php echo e(request()->is('*/document') ? 'active' : ''); ?>"  href="<?php echo e(route('seller.viewDocument')); ?>"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">Document</span></a>
                    </li>
