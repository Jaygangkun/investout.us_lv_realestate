    ...
    <nav class="navbar navbar-inverse custom-navbar  navbar-fixed-top">
        <div class="container-fluid ">
            ...
            <span class="icon-bar"></span>
                ...
                ?>
                <a class="navbar-brand custom-navbar-brand" href="<?php echo e($admin_logo_url); ?>">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(route('profile.show',$user->roles()->first()->slug)); ?>">View Your Profile</a></li>
                            <li><a href="<?php echo e(route('profile.edit',$user->roles()->first()->slug)); ?>">Edit Your Profile</a></li>
                            <?php if($user->roles()->first()->slug == 'realtor'): ?>
                                <li><a href="<?php echo e(route('realtors.billingDetails')); ?>">Billing Details</a></li>
                            <?php elseif($user->roles()->first()->slug == 'seller'): ?>
                                <li><a href="<?php echo e(route('seller.billingDetails')); ?>">Billing Details</a></li>
                            <?php endif; ?>
