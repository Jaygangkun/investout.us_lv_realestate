                        ...
                        <div class="property-price d-flex justify-content-center foo">
                            <div class="card-header-c d-flex">
                                <div class="card-title-c align-self-center">
                                    <h5>Asking Price</h5>
                                    <h5 class="title-c">$ <span class="priceNew"><?php echo e(number_format($details->investment_price) ?? '0'); ?></span></h5>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url    : '<?php echo e(route("admin.property.investorProposals.list")); ?>',
            method : "POST",
